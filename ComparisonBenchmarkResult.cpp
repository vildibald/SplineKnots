...
ComparisonBenchmarkResult::ComparisonBenchmarkResult(double first_alg_time,
                                                     double second_alg_time)
        : first_alg_(first_alg_time), second_alg_(second_alg_time){
    ratio_ = first_alg_time / second_alg_time;
}
